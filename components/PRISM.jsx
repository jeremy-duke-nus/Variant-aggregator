        ...
        <div className="results">
            ...
            {loading  ? <LoadScreen /> 
                    ...
                    :  <Card className="prism-card">
                        <Card.Body>
                            <Card.Title><h2>SingHealth PRISM </h2></Card.Title>
                            <Card.Text>
                                <br></br>
                                <p>PRISM search: <b>chr{prismData.results.query.chrom}/
                                {prismData.results.query.position}{prismData.results.query.reference}>{prismData.results.query.variant}</b></p>
                                <p>Variant Found in PRISM BEACON: <b>{prismData.results.exists}</b></p>
                            </Card.Text>
                        </Card.Body>
                    </Card>
            }
